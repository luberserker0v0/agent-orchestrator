...
describe('WSRouter', () => {
  ...
  beforeEach(() => {
    ...
    router = new WSRouter(
      ...
      { runtime: 'direct', maxInstances: 10, idleTimeoutMs: 600000, idleSweepIntervalMs: 60000, portRange: { start: 30000, end: 30100 }, healthCheck: { retries: 10, intervalMs: 500 }, opencodeBinary: 'opencode', agentType: 'opencode', docker: { image: 'opencode:latest', containerPort: 30000 } },
      mockConfigService,
      mockAgentService,
      mockSkillService,
      mockRuntimeRegistry
  ...
  it('handles conversation.restart in docker runtime', async () => {
    ...
    const dockerRouter = new WSRouter(
      ...
      { heartbeatIntervalMs: 5000, idleTimeoutMs: 10000 },
      { port: 8080, host: '127.0.0.1', shutdownTimeoutMs: 15000 },
      { runtime: 'docker', maxInstances: 10, idleTimeoutMs: 600000, idleSweepIntervalMs: 60000, portRange: { start: 30000, end: 30100 }, healthCheck: { retries: 10, intervalMs: 500 }, opencodeBinary: 'opencode', agentType: 'opencode', docker: { image: 'opencode:latest', containerPort: 3000 } },
      mockConfigService,
      mockAgentService,
      mockSkillService,
      mockRuntimeRegistry
