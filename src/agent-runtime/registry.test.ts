...
describe('RuntimeRegistry', () => {
  ...
  it('registers and retrieves a runtime by id', () => {
    ...
    registry.register('test-runtime', mockRuntime);
  ...
  it('register throws on duplicate id', () => {
    const registry = new RuntimeRegistry();
    registry.register('test-runtime', mockRuntime);
    expect(() => registry.register('test-runtime', mockRuntime)).toThrow(
  ...
  it('has returns true for registered type', () => {
    const registry = new RuntimeRegistry();
    registry.register('my-rt', mockRuntime);
    expect(registry.has('my-rt')).toBe(true);
  ...
  it('supports multiple runtimes simultaneously', () => {
    ...
    const registry = new RuntimeRegistry();
    registry.register('rt1', rt1);
    registry.register('rt2', rt2);
